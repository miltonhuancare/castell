                ...
                <section class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <form method="post" action="<%=request.getContextPath()%>/campain/save" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="nombre" class="form-control" value="${capain.nombre}" >
                            </div>
                        </div>
                            ...
                            <div class="col-sm-10">
                                <input type="date" name="fechaInicio" class="form-control" value="${capain.fechaInicio}" >
                            </div>
                        </div>
                             <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="date" name="fechaFin" class="form-control" value="${capain.fechaFin}" >
                            </div>
                        </div>
